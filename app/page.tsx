...
// 1. IMPORTAMOS TU UTILIDAD (Asegúrate de que la ruta sea correcta)
        ...
        <div className="min-h-screen bg-slate-50 font-sans">
            ...
            <main className="max-w-5xl mx-auto p-6">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
                    {(modules || []).map((mod) => {
                        // 3. USAMOS DIRECTAMENTE EL STRING DE LA BBDD
                        // Si viene null, ponemos 'Box' como fallback
