...
import { FileUp, FolderTree, CreditCard, Settings2, Scale, NotebookTabs, LinkIcon, ChartPie, ZoomIn, ChartNoAxesCombined } from 'lucide-react';
...
interface FinanceMenuProps {
    ...
    currentPanel?: 'dashboard' | 'transactions' | 'analytics' | 'investments'; // Para saber qué panel está activo en modo operativo
}
    ...
    if (mode === 'operative') {
        return (
            <>
                ...
                <SidebarMenuItem>
                    <SidebarMenuButton 
                    isActive={currentPanel === 'investments'}
                    tooltip="Análisis de inversiones"
                    className={cn(
                        "transition-all duration-200",
                        // 1. ESTADO ACTIVO: Contraste total y bloqueo de hover
                        "data-[active=true]:!bg-indigo-700 data-[active=true]:!text-indigo-50 data-[active=true]:font-bold",
                    ...
                    >
                        ...
                        <Link href="/finance/investments">Análisis de Inversiones</Link>
                    </SidebarMenuButton>
                </SidebarMenuItem>
                <SidebarSeparator />
