                ...
                <SidebarContent>
                    ...
                    {backLink && (
                      <>  
                        ...
                        <SidebarMenuItem>
                            <SidebarMenuButton asChild className="px-2 mb-2">
                                <Link href={Array.isArray(backLink)?backLink[0]:backLink} className="flex items-center gap-2 py-2 px-3 rounded-lg bg-slate-100 hover:bg-slate-200 text-slate-600 transition-all group">
                                    <ChevronLeft className="h-4 w-4" />
                                    <span className="text-[11px] font-bold uppercase tracking-tighter">{Array.isArray(backLink)?backLink[1]:"Volver"}</span>
                                </Link>
                            </SidebarMenuButton>
                        </SidebarMenuItem>
                      </>
